local ChairOffsets = {
	...
	["models/gmod_tower/plazabooth.mdl"] = {
		Vector(26.779298782348, -48.443725585938, 17.575805664063),
	...
	["models/props_interiors/furniture_chair03a.mdl"] = {
		Vector(-0.409963226318, 0.2439781188965, -3.97882232666),
	},
...
hook.Add("KeyRelease", "EnterDaSeat", function(ply, key)
	...
	if trace.Entity:GetClass() == "prop_vehicle_jeep" then return end
...
local function PlayerExitLeft(ply)
